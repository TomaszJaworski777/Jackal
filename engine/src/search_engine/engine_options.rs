...
create_options! {
    EngineOptions {
        ...
        Tunables {
            ...
            //CPUCT
            cpuct_step1: f64  =>  0.780000,  0.1,  5.0,  0.10,  0.002;
            cpuct_step2: f64  =>  0.686239,  0.1,  5.0,  0.10,  0.002;
            cpuct_step3: f64  =>  0.610238,  0.1,  5.0,  0.10,  0.002;
            cpuct_step4: f64  =>  0.548633,  0.1,  5.0,  0.10,  0.002;
            cpuct_step5: f64  =>  0.288205,  0.1,  5.0,  0.10,  0.002;
