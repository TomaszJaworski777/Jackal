...
create_options! {
    EngineOptions {
        ...
        Tunables {
            ...
            //CPUCT
            depth_1_cpuct: f64  =>  0.78,  0.1,  5.0,  0.10,  0.002;
            depth_2_cpuct: f64  =>  0.686,   0.1,  2.5,  0.03,  0.002;
            depth_3_cpuct: f64  =>  0.61,  0.1,  1.0,  0.05,  0.002;
            depth_4_cpuct: f64  =>  0.5,  0.1,  1.0,  0.05,  0.002;
            depth_5_cpuct: f64  =>  0.3,  0.1,  1.0,  0.05,  0.002;
