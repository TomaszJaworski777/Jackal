...
create_options! {
    EngineOptions {
        ...
        Tunables {
            ...
            //Material Scaling
            knight_value: f64          =>  437.0,   150.0,  750.0,   25.0,  0.002;
            bishop_value: f64          =>  409.0,   150.0,  750.0,   25.0,  0.002;
            rook_value: f64            =>  768.0,   400.0,  1000.0,  30.0,  0.002;
            queen_value: f64           =>  1512.0,  900.0,  2000.0,  35.0,  0.002;
            material_offset: f64       =>  559.0,   400.0,  1200.0,  40.0,  0.002;
            material_scale: f64        =>  36.0,    16.0,    64.0,    3.0,   0.002;
            material_bonus_scale: f64  =>  1226.0,  500.0,  1500.0,  64.0,  0.002;
