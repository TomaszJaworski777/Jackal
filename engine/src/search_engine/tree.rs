...
use crate::search_engine::{butterfly_history::ButterflyHistory, engine_params::EngineParams, hash_table::HashTable};
...
impl Tree {
    pub fn from_bytes(megabytes: usize, options: &EngineParams) -> Self {
