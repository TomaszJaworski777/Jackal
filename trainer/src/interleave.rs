...
use bullet::game::formats::montyformat::{FastDeserialise, MontyFormat};

#[allow(unused)]
pub fn interleave() -> std::io::Result<()> {
    let folder_path = "F:/Personal/Projects/Jackal/data"; // Specify the folder to scan
