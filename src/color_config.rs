...
impl Colored for String {
    fn label(&self) -> Self {
        self.truecolor(
            ColorConfig::LABEL_COLOR.0,
            ColorConfig::LABEL_COLOR.1,
            ColorConfig::LABEL_COLOR.2,
        )
        .to_string()
    }
    fn highlight(&self) -> Self {
        self.truecolor(
            ColorConfig::HIGHLIGHT_COLOR.0,
            ColorConfig::HIGHLIGHT_COLOR.1,
            ColorConfig::HIGHLIGHT_COLOR.2,
        )
        .to_string()
    }
    fn highlight_alt(&self) -> Self {
        self.truecolor(
            ColorConfig::HIGHLIGHT_ALT_COLOR.0,
            ColorConfig::HIGHLIGHT_ALT_COLOR.1,
            ColorConfig::HIGHLIGHT_ALT_COLOR.2,
        )
        .bold()
        .to_string()
    }
