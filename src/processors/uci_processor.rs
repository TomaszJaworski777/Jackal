...
impl UciProcessor {
    ...
    fn position( args: &[String], search_engine: &mut SearchEngine ) {
        ...
        fn map_move<const STM_WHITE: bool, const NSTM_WHITE: bool>(mv: &String, chess_position: &mut ChessPosition) {
            let mut _mv = Move::NULL;
            chess_position.board().map_moves::<_, STM_WHITE, NSTM_WHITE>(|legal_mv| { 
