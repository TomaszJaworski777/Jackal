...
impl SearchLimits {
    ...
    pub fn is_soft_time_limit_reached(
        ...
        if let Some(soft_limit) = self.soft_limit {
            ...
            let best_move_score = tree[tree.root_index()]
                .get_best_move(tree, options.draw_score())
                .1
                .as_cp_f32(0.5); //TODO: test adding contempt here
            ...
            let best_action_index =
                tree[tree.root_index()].get_best_action(tree, options.draw_score());
